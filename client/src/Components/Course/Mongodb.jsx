            ...
            <div className="container-xxl py-5">
                <div className="container">
                    ...
                    <div className="row g-2 justify-content-center">
                        ...
                        <Coursecart link="" title="01. The Mongo Shell" desc="Introduction of Mongo Shell." />

                        <Coursecart link="" title="02. Document _ Collection" desc="How to store Document Collection in mongodb." />

                        <Coursecart link="" title="03. INSERT in DB (InsertOne)" desc="How to insert data into DB (InsertOne)." />

                        <Coursecart link="" title="04. INSERT in DB (InsertMany)" desc="How to insert data into DB (InsertMany)." />
